...
public class SendDataToDownloadTafseer {
    ...
    private static final String TAG = "SendDataToDownloadTafseer";
    private  int i , n ,k;
...
//        if (database.tafseerAyatsDao().getCount() == 6236 && database.tafseerIdDao().getCount() > 0 && tafseerAyats.size()!=0)
        // There is an Existed Tafseer with another ID
        if (database.tafseerAyatsDao().getCount() >0)
        {
